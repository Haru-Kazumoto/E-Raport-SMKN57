...
if ($op!='') {
	...
	if ($jenis=='PD') {
		...
		if (($cek=='') && ($jsiswa>1)) {
			...
			sebelum melakukan penilaian antar peserta didik. <a href=# onclick=bukaAjax('content','index2.php?det=inputnilaisikap&jpx=2')>Klik di sini </a> untuk memasukkan nilai antar peserta didik.
			</div>";
			exit;
			}

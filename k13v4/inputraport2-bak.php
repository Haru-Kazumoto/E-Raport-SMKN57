...
cekVar("kode_kelas,cetak,asf,jmid,nis,jcetak2,media,media2,semester,orientasi");
	...
	*/
	...
	if ($jcetak2=='siswa') { //pencetakan 1 siswa	
		...
		if ($orientasi=='landscape')
			include "raport2-mid-portrait.php";
		else	
			include "raport2-mid-portrait.php";
...
<tr class=troddform2 $sty >
	...
	<td><input type=hidden name=tahun id=tahun_<?=$rnd?> value='<?=$thpl4?>'><?=$thpl4?></td> 
</tr>
...
<tr class=troddform2 $sty >
	...
	<td><input type=text name=tglcetak id=tglcetak_<?=$rnd?> onmousemove=bukaTgl(this.name)></td> 
</tr>
<tr class=troddform2 $sty >
...
?>
 <tr class=troddform2 $sty >
	...
	$onc3="onclick=\"$('#media2').val('pdf');$onc;\" ";
	echo "<input type=hidden id='jmid' name='jmid' value='$jmid'>";
	echo "<input type=hidden id='media2' name='media2' value=''>";
	echo "<input type=button value='Cetak $judul' target=_blank class='btn btn-success btn-sm' $onc1 >&nbsp; &nbsp; ";
	echo "<input type=button value='Export ke DOC' target=_blank class='btn btn-primary btn-sm'$onc2 >";
	echo "<input type=button value='Export ke PDF' target=_blank class='btn btn-primary btn-sm'$onc3 >";

...
$nfAppA1="SISTEM INFORMASI PENILAIAN SMK";
$nfAppA2="KURIKULUM SMK PUSAT KEUNGGULAN <br>& PROFIL PELAJAR PANCASILA";
$timeoutSesi=60;		  
...
cekVar("dbku4,useJS,showHeader,page,media,media2,cetak,thpl4,newrnd");
//$tppath="template/dashgumfree_v2/";
...
$sJenisMP="Kelompok A (Umum),Kelompok B (Kejuruan),C1 (Dasar Bidang Keahlian),C2 (Dasar Program Keahlian),C3 (Paket Keahlian),Mulok";
...
//echo "sampai sini........$isLogin ".$_SESSION["usrid"];exit;

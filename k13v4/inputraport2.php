...
//echo $o="orientasi : $orientasi ... jcetak $jcetak >";
...
if ($kode_kelas!='') {
	...
	*/
	...
	if ($jcetak=='raportkeg') {
		$nfRaport="raport2-mid-kegiatan.php";
	} else {
	...
	if ($jcetak2=='siswa') { //pencetakan 1 siswa	
		...
		if ($media2=='pdf') {
			...
			$shtml=str_replace("#pb#","</div><div class='page f14px'>"
			,"<div class='page f14px'>$shtml</div>");
			//echo showta($shtml);exit;
			if ($media2=='doc') {
...
elseif ($jcetak=='raportkeg') {
	$judul="Raport Kegiatan";
	$jc="Raport";
}
...
<tr class=troddform2 $sty >
	<td class=tdcaption >Tanggal <?=$jc?></td>
